...
then
    ...
    echo "Creating two more partitions (7.6 GB and 'rest')"
    TARGET_DEV=/dev/mmcblk0
    # parted --script $TARGET_DEV 'mkpart primary ext4 1100 -1'
    parted --script $TARGET_DEV 'mkpart primary ext4 850 9000'
    parted --script $TARGET_DEV 'mkpart primary ext4 9050 -1'
